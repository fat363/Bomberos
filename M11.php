...
// Consulta para obtener los subequipos con id_vehiculo = 3
$sql = "SELECT id_vehiculo, Nombre, disponible, condicion FROM subequipos WHERE id_vehiculo = 3";
...
<head>
    ...
    <title>M11-Renault Thomas</title>

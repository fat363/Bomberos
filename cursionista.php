...
<body>
    ...
    <div class="container">
        ...
        <form action="cursionistas2.php" method="post">
            ...
            <div class="form-group">
                <label for="id_curso">Selecciona una capacitacion:</label>
                <select id="id_curso" name="id_curso">
                    <option value="1">Curso Basico de Bombero voluntario</option>
                    ...
                    <option value="8">Sub oficial mayor</option>
                    <option value="9">Oficial ayudante</option>
                    <option value="10">Sub inspector</option>
                    <option value="11">Oficial inspector</option>

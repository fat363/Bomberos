...
// Consulta para obtener los subequipos con id_vehiculo = 6
$sql = "SELECT id_vehiculo, Nombre, disponible, condicion FROM subequipos WHERE id_vehiculo = 6";
...
<head>
    ...
    <title>M14-Amarok Logistica</title>
...
<body>
    <div class="container">
        ...
        <?php if (!empty($subequipos)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>No hay subequipos disponibles para este vehiculo</p>
        <?php endif; ?>
    </div>
</body>
</html>

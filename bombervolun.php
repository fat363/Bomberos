...
<body>
    ...
    <div class="auth-buttons">
        <form action="bomberos2.php" method="post" style="display:inline;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-spacer">
        <div class="container">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="cursionista.php">Calificaciones</a>
                </li>
            </ul>
        </div>
    </nav>
    <div id="carouselExampleCaptions" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="bomberos6.jpeg"  class="d-block w-100" alt="ropa de bomberos">
            </div>
            <div class="carousel-item">

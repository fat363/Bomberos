...
// Consulta para obtener los subequipos con id_vehiculo = 2
$sql = "SELECT id_vehiculo, Nombre, disponible, condicion FROM subequipos WHERE id_vehiculo = 2";
...
<head>
    ...
    <title>M10-Amarok kit Forestal</title>

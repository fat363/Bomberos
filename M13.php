...
// Consulta para obtener los subequipos con id_vehiculo = 5
$sql = "SELECT id_vehiculo, Nombre, disponible, condicion FROM subequipos WHERE id_vehiculo = 5";
